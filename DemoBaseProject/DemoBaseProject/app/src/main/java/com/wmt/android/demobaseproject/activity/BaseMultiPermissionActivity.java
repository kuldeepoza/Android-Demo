...
public abstract class BaseMultiPermissionActivity extends BaseActivity implements MultiplePermissionsListener,
        PermissionRequestErrorListener,
        AlertDialogFragment.OnAlertDialogClickListener {


    public static final String TAG = BaseMultiPermissionActivity.class.getSimpleName();
