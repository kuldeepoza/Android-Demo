...
public abstract class BaseSinglePermissionActivity extends BaseActivity implements PermissionListener,
        PermissionRequestErrorListener,
        AlertDialogFragment.OnAlertDialogClickListener {

    public static final String TAG = BaseSinglePermissionActivity.class.getSimpleName();
